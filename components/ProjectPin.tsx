...
export function ProjectPin({
  ...
  return (
    <button
      ...
      className={`group relative flex h-7 w-7 items-center justify-center rounded-full border-0 bg-transparent p-0 outline-none transition-all duration-panel ease-out ${
        isVisible
    ...
    >
      ...
      <span
        className={`relative flex h-5 w-5 items-center justify-center rounded-full shadow-pin transition-transform duration-200 ${
